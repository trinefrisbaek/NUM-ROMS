#!/bin/bash
#
# svn $Id: build.bash 893 2018-02-11 03:54:11Z arango $
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
# to the code and inputs on differing machines.
 ...
 export       MY_ROMS_SRC=${MY_ROOT_DIR}/trunk_svn904_NUM
...
# these configurations files up-to-date.
 ...
 export         NUMDIR=${MY_ROMS_SRC}/ROMS/External/num
...
# many definitions as you want by appending values.
 ...
 export      MY_CPP_FLAGS="-DAVERAGES"
 export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DBIO_NUM"
...
# Compile.
#--------------------------------------------------------------------------
if [[ $MY_CPP_FLAGS == *"DBIO_NUM"* ]]; then
  makefilename="makefile_num"
else
...
if [ $dprint -eq 1 ]; then
  make -f $makefilename $debug
else
  if [ $parallel -eq 1 ]; then
    make -f $makefilename $NCPUS
  else
    make -f $makefilename
  fi
fi
