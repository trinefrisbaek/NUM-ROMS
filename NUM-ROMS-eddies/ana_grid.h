...
!
     ...
     &           8.0_r8*EXP(-val1*val1)
      ...
      DO i=IstrT,IendT
          ...
          END IF
          val2=MIN(depth,-2.2161_r8-(EXP(-0.0138_r8*val1)-1.0329_r8)*(1.4992E+03_r8+(949.8679_r8*TANH((val1-26.0_r8)/2.0_r8))))
          !val2=MIN(depth,-2.2161_r8-(EXP(-0.0138_r8*val1)-1.0329_r8)*(1.4992E+03_r8+(949.8679_r8*TANH((val1-24.6866_r8)/0.7703_r8))))
          !val2=MIN(depth,-14.258250760558425_r8-(EXP(-0.028466975059695_r8*val1)-1.047844967388447_r8)*(1.415375803345926E+03_r8+(872.3273955429024_r8*TANH((val1-12.619409129083529_r8)/1_r8))))
          !val2=MIN(depth,-14.258250760558425_r8-(EXP(-0.028466975059695_r8*val1)-1.047844967388447_r8)*(1.415375803345926E+03_r8+(872.3273955429024_r8*TANH((val1-12.619409129083529_r8)/0.383411638010292_r8))))
          !val2=MIN(depth,-(EXP(-1.0_r8/2.5_r8*val1)-1.0_r8)*(292.583_r8+(199.0_r8*TANH((val1-22.0_r8)/7.0_r8))))
          DO j=JstrT,JendT
            h(i,j)=MAX(val2,20.0_r8)
          END DO
        END DO
